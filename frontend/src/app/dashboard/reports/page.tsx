            ...
            <div className="grid gap-4 md:gap-6 grid-cols-2 lg:grid-cols-4">
                <Card className="border-[var(--border)] bg-[var(--card)] shadow-sm">
                    <CardHeader className="pb-2">
                        <CardTitle className="text-sm font-medium text-muted-foreground">Average Monthly Income</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <div className="text-xl md:text-2xl font-bold text-[#4ade80]">$5,350</div>
                ...
                <Card className="border-[var(--border)] bg-[var(--card)] shadow-sm">
                    <CardHeader className="pb-2">
                        <CardTitle className="text-sm font-medium text-muted-foreground">Average Monthly Expenses</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <div className="text-xl md:text-2xl font-bold text-[#f87171]">$4,033</div>
                        <p className="text-xs text-muted-foreground flex items-center gap-1">
                ...
                <Card className="border-[var(--border)] bg-[var(--card)] shadow-sm">
                    <CardHeader className="pb-2">
                        <CardTitle className="text-sm font-medium text-muted-foreground">Average Monthly Savings</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <div className="text-xl md:text-2xl font-bold text-[#60a5fa]">$1,317</div>
                        <p className="text-xs text-muted-foreground flex items-center gap-1">
                            <TrendingUp className="h-3 w-3 text-[#4ade80]" />
                ...
                <Card className="border-[var(--border)] bg-[var(--card)] shadow-sm">
                    ...
                    <CardContent>
                        <div className="text-xl md:text-2xl font-bold text-[#a78bfa]">24.6%</div>
                        <p className="text-xs text-muted-foreground flex items-center gap-1">
                            <TrendingUp className="h-3 w-3 text-[#4ade80]" />
            ...
            <div className="grid gap-4 grid-cols-1 md:gap-6 lg:grid-cols-8">
                <Card className="col-span-full lg:col-span-5 border-[var(--border)] bg-[var(--card)] shadow-sm">
                    <CardHeader>
                        ...
                        <CardDescription>Monthly comparison of income, expenses, and savings</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <ChartContainer config={{
                            ...
                            <BarChart accessibilityLayer data={monthlyData} barSize={10} barCategoryGap="30%">
                                ...
                                <ChartLegend verticalAlign="bottom" wrapperStyle={{ bottom: -10 }} />
            ...
            <div className="grid gap-4 grid-cols-1 md:gap-6 lg:grid-cols-8">
                ...
                <Card className="col-span-full lg:col-span-5 border-[var(--border)] bg-[var(--card)] shadow-sm">
                    <CardHeader>
                        ...
                        <CardDescription>How spending in each category has changed over time</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <ChartContainer
                            config={{
                        ...
                        >
                            <LineChart data={categoryTrends}>
                                ...
                                <Line type="monotone" dot={false} dataKey="Food" stroke="#8b5cf6" strokeWidth={2} />
                                <Line type="monotone" dot={false} dataKey="Transport" stroke="#06b6d4" strokeWidth={2} />
                                <Line type="monotone" dot={false} dataKey="Shopping" stroke="#f59e0b" strokeWidth={2} />
                                <Line type="monotone" dot={false} dataKey="Bills" stroke="#ef4444" strokeWidth={2} />
                            </LineChart>
                        </ChartContainer>
                    </CardContent>
                </Card>
