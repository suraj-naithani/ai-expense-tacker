      ...
      <div className="space-y-4 md:space-y-6">
        ...
        <Card className="border-[var(--border)] bg-[var(--card)] shadow-sm">
          <CardHeader>
            ...
            <CardDescription>
              Common actions for managing your money records
            </CardDescription>
          </CardHeader>
          <CardContent>
          ...
          <CardContent>
            ...
            >
              <TabsList className="grid w-full grid-cols-2 bg-[var(--card-hover)] ]">
                <TabsTrigger
                  value="lent"
                  className="data-[state=active]:bg-[#6366f1]"
                >
                  ...
                  <Table>
                    ...
                    <TableBody>
                      {lentMoney.map((record) => (
                        <TableRow
                          key={record.id}
                          className="hover:bg-[var(--card-hover)] border-[var(--border)]"
                        >
                          <TableCell>
        ...
        <Card className="border-[var(--border)] bg-[var(--card)] shadow-sm">
          <CardHeader>
            ...
            <CardDescription>
              Latest updates on your money records
            </CardDescription>
          </CardHeader>
          <CardContent>
