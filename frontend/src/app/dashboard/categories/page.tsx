            ...
            <div className="space-y-4 md:space-y-6">
                ...
                <div className="grid gap-4 md:gap-6 grid-cols-1 md:grid-cols-3">
                    ...
                    <Card className="border-[var(--border)] bg-[var(--card)] shadow-sm">
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold text-[#f97316]">${totalSpent.toFixed(2)}</div>
                    ...
                    <Card className="border-[var(--border)] bg-[var(--card)]  shadow-sm">
                        ...
                        <CardContent>
                            <div className="text-xl md:text-2xl font-bold text-[#4ade80]">${(totalBudget - totalSpent).toFixed(2)}</div>
                                    ...
                                    >
                                        <div className="flex items-center justify-between mb-2">
                                            ...
                                            <DropdownMenu>
                                                ...
                                                <DropdownMenuContent align="end" className="bg-[var(--border)] border-[var(--card)]">
                                        ...
                                        <div className="space-y-1">
                                            <div className="text-lg font-bold">${category.spent.toLocaleString()}</div>
