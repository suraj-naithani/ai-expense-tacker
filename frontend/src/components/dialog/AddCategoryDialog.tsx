...
interface AddCategoryDialogProps {
    ...
    onSave?: (category: { name: string; icon?: string; userId: string }) => void;
}
                ...
                <DialogContent className="sm:max-w-[425px] bg-[var(--background)] border-[var(--border)] z-110">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4 py-4">
                        ...
                        <DialogFooter>
                            ...
                            <Button
                                type="submit"
                                disabled={!name || !icon || !user?.id}
                                className="bg-[#6366f1] hover:bg-[#4f46e5] cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                Create Category
                            </Button>
                        </DialogFooter>
